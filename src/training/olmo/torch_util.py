...
def set_cpu_affinity(local_rank):
    """Set the CPU affinity for the current process to the CPU cores if training on LUMI."""
    LUMI_GPU_CPU_map = {
    ...
    print(f"Rank {get_global_rank()} (local {local_rank}) binding to cpus: {cpu_list}")
